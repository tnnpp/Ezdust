"""
Django settings for ezdust project.
...
SECRET_KEY = 'django-insecure-s6p)0x8k%6sv(z&5*9fityfs^7mr0nd3zl(bg1l_2j4ct_)pfu'
...
MEDIA_DIRS = [os.path.join(BASE_DIR, 'btre/media')]
MEDIA_URL = 'media/'
